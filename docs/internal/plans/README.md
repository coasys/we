...
| `module-marketplace.md`                               | Design only. Predates most of the surfaces it would need to cover — it names four types where `docs/contributing/surfaces.md` lists nineteen                                    |
