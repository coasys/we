...
| Model              | 5 (`@we/models` manifest) for core; **2** for community shapes | 2                          | Done for community models. Core models stay merge-only because the app's own stores are written against them.                                                                                                                     |
