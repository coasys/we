...
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[design-system/](./packages/design-system)**   | `@we/tokens` `@we/themes` `@we/primitives` `@we/components` `@we/widgets` `@we/design-types` `@we/design-utils` `@we/drag`             | Tokens → Lit primitives → Solid components/widgets, the DS-props machinery, and the shared drag session                                                               |
| **[schema-system/](./packages/schema-system)**   | `@we/schema-shared` `@we/schema-solid` `@we/schema-kit`                                                                                | Schema semantics (framework-neutral), the Solid renderer, and the portable fragment kit                                                                               |
| **[block-system/](./packages/block-system)**     | `@we/block-shared` `@we/block-solid`                                                                                                   | Block-based content composition (ProseMirror composer, standoff marks, model persistence)                                                                             |
...
| **[module-system/](./packages/module-system)**   | `@we/module-shared` `@we/module-call` `@we/module-notes` `@we/module-transcribe` `@we/module-graph` `@we/module-pocket` + globe family | The feature-module contract and the bundled modules                                                                                                                   |
| **[templates/](./packages/templates)**           | `@we/template-kit` `@we/template-shell` `@we/template-default` `@we/template-views` `@we/template-showcase` `@we/template-fixtures`    | WE-domain fragments, the shell surfaces, the built-in space templates, the sections a space is made of, the showcase shells, and the fixtures both are tested against |
...
| **[models](./packages/entities)**                | `@we/entities`                                                                                                                         | WE's domain models (Space, blocks, …)                                                                                                                                 |
