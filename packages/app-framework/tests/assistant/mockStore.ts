 ...
 */
import type { AssistantStore } from '@solid/stores/AssistantStore';
import { parseIdList } from '@solid/stores/AssistantStore';
import type { Assistant, McpServer, Message, Personality, Skill, Thread } from '@we/models';
