...
import { AssistantMessage } from '@solid/components/assistant/AssistantMessage';
...
function msg(over: Partial<Message>): Message {
  return { id: 'x', threadId: 't1', role: 'assistant', content: '', toolCalls: '', ts: '', status: 'complete', ...over } as unknown as Message;
}
...
describe('AssistantMessage', () => {
  ...
  it('shows a "streaming…" tag once streamed tokens have started arriving', () => {
    render(() => <AssistantMessage message={msg({ role: 'assistant', content: 'partial answer', status: 'streaming' })} />);
