 ...
 */
import { landingPageTemplate, livingSystemsTemplate, profileTemplate, schemaTestsTemplate, settingsTemplate } from '@shared/schemas';
...
const shellViews: Record<string, ShellViewEntry> = {
  ...
  'living-systems': { schema: livingSystemsTemplate },
