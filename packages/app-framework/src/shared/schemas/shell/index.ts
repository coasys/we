...
export { forCommunitiesTemplate } from './about/ForCommunities.schema';
export { forBuildersTemplate } from './about/ForBuilders.schema';
export { howItWorksTemplate } from './about/HowItWorks.schema';
export { seeItInPracticeTemplate } from './about/SeeItInPractice.schema';
