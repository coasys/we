  ...
  primitives: [
    ...
    },
    {
      ...
      ownProps: [
        ...
        { name: 'within', type: 'DragWithin | undefined', optional: true },
    ...
    {
      tagName: 'we-live-cursor',
      className: 'LiveCursor',
      superclass: 'DesignSystemElement',
      ownProps: [
        { name: 'name', type: 'string', optional: false, default: "''" },
        { name: 'hash', type: 'string', optional: false, default: "''" },
    ...
    },
    {
      ...
      ownProps: [
        ...
        { name: 'relativeStyle', type: "'long' | 'short' | 'narrow'", optional: false, default: "'long'" },
        { name: 'locale', type: 'string', optional: false, default: "'en'" },
        { name: 'dateStyle', type: "'full' | 'long' | 'medium' | 'short' | null", optional: false, default: 'null' },
        { name: 'timeStyle', type: "'full' | 'long' | 'medium' | 'short' | null", optional: false, default: 'null' },
        { name: 'weekday', type: "'long' | 'short' | 'narrow' | null", optional: false, default: 'null' },
        { name: 'year', type: "'numeric' | '2-digit' | null", optional: false, default: 'null' },
        {
          name: 'month',
          type: "'numeric' | '2-digit' | 'long' | 'short' | 'narrow' | null",
          optional: false,
          default: 'null',
        },
        { name: 'day', type: "'numeric' | '2-digit' | null", optional: false, default: 'null' },
        { name: 'hour', type: "'numeric' | '2-digit' | null", optional: false, default: 'null' },
        { name: 'minute', type: "'numeric' | '2-digit' | null", optional: false, default: 'null' },
        { name: 'second', type: "'numeric' | '2-digit' | null", optional: false, default: 'null' },
        { name: 'timeZone', type: 'string | null', optional: false, default: 'null' },
        { name: 'hourCycle', type: "'h11' | 'h12' | 'h23' | 'h24' | null", optional: false, default: 'null' },
  ...
  components: [
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'sourceAuthor', type: 'string', optional: true },
    ...
    },
    {
      ...
      props: [
        { name: 'styles', type: 'Record<string, string | number>', optional: true },
        { name: 'class', type: 'string', optional: true },
        { name: 'onSelect', type: '((item: DropdownMenuAction | DropdownMenuToggle) => void)', optional: true },
    ...
    },
    {
      ...
      props: [
        ...
        {
          name: 'onDrop',
          type: '((payload: { entity: string; id: string; dataset?: string; label: string; x: number; y: number; within?: { entity: string; id: string; }; preview?: { thumbnail?: string; author?: string; source?: string; }; }) => void)',
          optional: true,
        },
  ...
  models: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'sourceRef', type: 'string', predicate: 'we://source_ref', required: false },
        { name: 'sourceName', type: 'string', predicate: 'we://source_name', required: false },
      ],
      relations: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'sourceAuthor', type: 'string', predicate: 'we://source_author', required: false },
        { name: 'sourceName', type: 'string', predicate: 'we://source_name', required: false },
  ...
  storeEntries: [
    ...
    },
    {
      ...
      state: {
        ...
        moduleLaunchers: { type: 'array', properties: ['id', 'icon', 'label', 'active', 'busy', 'concealed'] },
  ...
  modules: [
    {
      ...
      members: [
        ...
        { name: 'arrangement', kind: 'state', doc: 'The { columns, rows } the stage is currently laid out in.' },
        {
          name: 'attachAnchor',
          kind: 'action',
        ...
        },
        {
          name: 'focusTile',
          kind: 'action',
          doc: 'Give the participant with this id the spotlight, or take it back if they already have it.',
        },
        {
          name: 'goToCall',
          kind: 'action',
        ...
        },
        {
          ...
          kind: 'action',
          doc: 'Join the call already happening about the record whose id is given, or start one about it.',
        },
        {
          name: 'joinCall',
          kind: 'action',
          doc: 'Join a running call by its id, as liveCalls lists it, leaving any call this agent is in.',
        },
        {
          name: 'leave',
          kind: 'action',
        ...
        },
        {
          name: 'solo',
          kind: 'state',
          doc: 'Whether the spotlight has the stage to itself, with everyone else hidden.',
        },
        {
          name: 'startCall',
          kind: 'action',
        ...
        { name: 'toggleAudio', kind: 'action', doc: 'Mute or unmute this agent’s microphone.' },
        {
          ...
          kind: 'action',
          doc: 'Start or stop sharing this agent’s screen; sharing replaces the camera until it stops.',
        },
        {
          name: 'toggleSolo',
          kind: 'action',
          doc: 'Hide everyone but the spotlight, or bring them back; does nothing while nobody is focused.',
        },
        {
          name: 'toggleVideo',
          kind: 'action',
      ...
      settings: [
        {
          ...
          label: 'ICE servers',
          description:
            'Where calls look for NAT traversal, one per line — stun:host:port, or turn:user:password@host:port for a relay. Empty uses public STUN, which cannot connect every pair of networks. A JSON array of RTCIceServer objects is also accepted.',
          type: 'string',
          levels: ['deployment', 'space', 'agent'],
        },
      ],
      activities: { call: { id: 'string', anchor: 'object', media: 'object', record: 'string', continued: 'boolean' } },
      components: [],
      functions: [],
      views: [],
      blocks: [],
    ...
    },
    {
      ...
      members: [
        ...
        { name: 'applyChange', kind: 'action', doc: 'Applies one suggested change to an agreed record.' },
        {
          name: 'autoExtract',
          kind: 'state',
          doc: 'Whether this call is extracted as it happens — its participants’ answer, else the space’s.',
        },
        {
          name: 'autoJoined',
          kind: 'state',
          doc: 'Recording was started by the call rather than by this agent pressing record.',
        },
        { name: 'available', kind: 'state', doc: 'There is audio to listen to — a microphone the host is capturing.' },
        {
          name: 'callAgents',
          kind: 'state',
          doc: 'Everyone in this call, recording or not — the denominator of coverage; empty outside a call.',
        },
        {
          name: 'callId',
          kind: 'state',
          doc: 'The record extraction decisions for this call are written against — the call’s own record from its first second.',
        },
        ...
        { name: 'canEditProposals', kind: 'state', doc: 'Whether an edited suggestion can be written back on accept.' },
        {
          ...
          kind: 'state',
          doc: 'Whether this connection may install the model the backend offers.',
        },
        { name: 'changedIds', kind: 'state', doc: 'Agreed records carrying a suggested change, by id.' },
        { name: 'closeExtractionPanel', kind: 'action', doc: 'Closes the extraction panel.' },
        { name: 'closePanel', kind: 'action', doc: 'Closes the transcript panel.' },
        {
          name: 'collectionId',
          kind: 'state',
        ...
        { name: 'editingProposal', kind: 'state', doc: 'The suggestion open for editing, or empty when none is.' },
        {
          name: 'editProposal',
          kind: 'action',
          doc: 'Opens one suggestion for editing, seeded with what the model proposed.',
        },
        {
          name: 'editUtterance',
          kind: 'action',
          doc: 'Corrects the words on a line of the transcript, marking a spoken line as corrected.',
        },
        { name: 'enabled', kind: 'state', doc: 'Whether this agent is recording their own microphone into the call.' },
        { name: 'error', kind: 'state', doc: 'Why the session stopped, when status is error; empty otherwise.' },
        { name: 'extract', kind: 'action', doc: 'Runs one extraction pass over the call this agent is transcribing.' },
        {
          name: 'extractable',
          kind: 'state',
          doc: 'Whether this node can interpret at all — false when it has no language model.',
        },
        { name: 'extractCollection', kind: 'action', doc: 'Runs one extraction pass over any call’s record, by id.' },
        { name: 'extractCount', kind: 'state', doc: 'How many records the last pass wrote.' },
        { name: 'extractedId', kind: 'state', doc: 'The collection the last finished pass ran on, or empty.' },
        { name: 'extractError', kind: 'state', doc: 'Why the last pass failed; empty otherwise.' },
        { name: 'extractingId', kind: 'state', doc: 'The collection a pass is running on right now, or empty.' },
        {
          name: 'extractionFor',
          kind: 'state',
          doc: 'What one call can extract, by record id — { targets, canChoose, canExtract }, read as extractionFor[id].',
        },
        { name: 'extractionOpen', kind: 'state', doc: 'Whether the extraction panel is open.' },
        {
          name: 'extractStatus',
          kind: 'state',
        ...
        { name: 'extractTurns', kind: 'state', doc: 'How many transcript turns the last pass read.' },
        {
          name: 'flushNow',
          kind: 'action',
          doc: 'Writes what has been heard so far without waiting for the buffer to fill.',
        },
        {
          name: 'heard',
          kind: 'state',
          doc: 'Something has been said that the record does not hold yet — buffered, being written or still with the model.',
        },
        { name: 'inCall', kind: 'state', doc: 'Whether this agent is in a call right now.' },
        { name: 'installError', kind: 'state', doc: 'Why the last model install failed; empty otherwise.' },
        { name: 'installingModel', kind: 'state', doc: 'A one-click model install is registering its model.' },
        {
          name: 'installModel',
          kind: 'action',
          doc: 'Installs the model the backend offers and resumes recording that was waiting on one.',
        },
        {
          name: 'installModelLabel',
          kind: 'state',
          doc: 'The install button’s words, naming the offered model and its size; empty when none is offered.',
        },
        {
          name: 'invited',
          kind: 'state',
          doc: 'Somebody else in this call is recording and this agent is not, having not opted out.',
        },
        {
          name: 'invitedBy',
          kind: 'state',
          doc: 'The agent id of the first peer recording this call, or empty when none is.',
        },
        { name: 'level', kind: 'state', doc: 'Microphone loudness as the voice detector measures it, 0–1.' },
        { name: 'levelPercent', kind: 'state', doc: 'The microphone level as a CSS width for a meter.' },
        {
          name: 'listening',
          kind: 'state',
          doc: 'True only while actually transcribing — what a record button highlights on.',
        },
        {
          name: 'liveCollectionId',
          kind: 'state',
          doc: 'The record the call this agent is in is writing into, or empty when there is none.',
        },
        {
          name: 'modelDownloading',
          kind: 'state',
          doc: 'A transcription model is installed and its weights are still arriving.',
        },
        {
          name: 'modelDownloadText',
          kind: 'state',
          doc: 'The download line, ready to show — "Downloading the speech model — 45%".',
        },
        ...
        { name: 'openExtractionPanel', kind: 'action', doc: 'Opens the extraction panel.' },
        { name: 'openPanel', kind: 'action', doc: 'Opens the transcript panel.' },
        { name: 'partialCoverage', kind: 'state', doc: 'Someone in this call is not being transcribed.' },
        {
          name: 'passRunning',
          kind: 'state',
          doc: 'Whether any extraction pass is running right now, this node’s or a peer’s.',
        },
        {
          name: 'pending',
          kind: 'state',
          doc: 'Words heard that are not yet a row in the transcript — buffered or being written, newest last.',
        },
        {
          name: 'pendingIds',
          kind: 'state',
          doc: 'Every record still awaiting a decision, by id, across every call asked about.',
        },
        {
          name: 'pendingProposals',
          kind: 'state',
          doc: 'The same suggestions as rows — { id, kind, entity, fields, summary }.',
        },
        {
          name: 'proposalDraft',
          kind: 'state',
          doc: 'What has been typed into the open suggestion, keyed by property name.',
        },
        {
          name: 'proposals',
          kind: 'state',
          doc: 'Suggestions staged on the live call — prefer proposalsFor with the call named.',
        },
        {
          name: 'proposalsFor',
          kind: 'state',
        ...
        { name: 'speaking', kind: 'state', doc: 'Whether the microphone level currently counts as speech.' },
        {
          name: 'status',
          kind: 'state',
          doc: 'What the session is doing — idle, no-backend, no-model, no-audio, downloading, starting, listening or error.',
        },
        {
        ...
        },
        {
          name: 'toggle',
          kind: 'action',
          doc: 'Starts or stops recording this agent’s microphone into the call, and opens the transcript when starting.',
        },
        {
          name: 'toggleAutoExtract',
          kind: 'action',
          doc: 'Turns automatic extraction on or off for this call, for everyone in it.',
        },
        {
          name: 'toggleExtractionTarget',
          kind: 'action',
          doc: 'Includes or excludes one model from what a call extracts, for everyone in it; defaults to the live call.',
        },
        {
          name: 'transcribers',
          kind: 'state',
          doc: 'Everyone recording this call, this agent included — the numerator of coverage.',
        },
        {
          name: 'transcribing',
          kind: 'state',
        ...
        { name: 'unconfirmedIds', kind: 'state', doc: 'Records a pass made that nobody has kept yet, by id.' },
        {
          name: 'watchProblem',
          kind: 'state',
          doc: 'Why the standing extraction watch is not running here; empty when it is.',
        },
      ],
      parts: [
        {
          name: 'transcriptFeed',
          subject: 'routeStore.params.call ? routeStore.params.call : modules.transcribe.collectionId',
        },
        { name: 'transcriptLines', subject: 'modules.transcribe.collectionId' },
        { name: 'transcriptComposer' },
        { name: 'captureMeter' },
        { name: 'captureStatus' },
        { name: 'coverage' },
        { name: 'extractionTargets' },
    ...
    },
    {
      ...
      members: [
        ...
        { name: 'driving', kind: 'state', doc: 'Whether this agent has the wheel.' },
        { name: 'faces', kind: 'state', doc: 'One entry per cursor on screen — { did, name, image }.' },
        { name: 'follow', kind: 'action', doc: 'Follow whoever has the wheel.' },
        { name: 'following', kind: 'state', doc: 'Whether this agent is following somebody’s screen.' },
        { name: 'followingName', kind: 'state', doc: 'The name of whoever this agent is following.' },
        { name: 'problem', kind: 'state', doc: 'Why something could not be done, as a sentence to show, or empty.' },
      ...
      activities: { live: { cursors: 'boolean' }, driving: { since: 'number' }, following: { id: 'string' } },
      components: [],
      functions: [],
      views: [],
      blocks: [],
    ...
    },
    {
      ...
      capabilities: ['kernel:agentData', 'storage:agent', 'dock'],
      members: [
        { name: 'close', kind: 'action', doc: 'Closes the Pocket panel.' },
        { name: 'open', kind: 'state', doc: 'Whether the Pocket panel is open.' },
        { name: 'show', kind: 'action', doc: 'Opens the Pocket panel and resolves the folder it was last looking at.' },
        { name: 'toggle', kind: 'action', doc: 'Opens the Pocket panel, or closes it if it is open.' },
      ],
      parts: [{ name: 'toggleButton' }],
      panels: [{ name: 'main', title: 'Pocket', icon: 'bag-simple', hostOwned: false }],
      launchers: [],
      settings: [],
      activities: {},
      components: [],
      ...
      entities: [
        {
          name: 'PocketFolder',
          className: 'PocketFolder',
          fields: [
            { name: 'name', type: 'string', predicate: 'we://module/pocket/name', required: false },
            { name: 'icon', type: 'string', predicate: 'we://module/pocket/icon', required: false },
            { name: 'color', type: 'string', predicate: 'we://module/pocket/color', required: false },
            { name: 'root', type: 'boolean', predicate: 'we://module/pocket/root', required: false },
            { name: 'createdOrder', type: 'number', predicate: 'we://module/pocket/createdOrder', required: false },
          ],
          relations: [
            { name: 'folders', kind: 'HasMany', predicate: 'we://module/pocket/folders', target: 'PocketFolder' },
            { name: 'items', kind: 'HasMany', predicate: 'we://module/pocket/items', target: 'PocketItem' },
          ],
        },
        {
          name: 'PocketItem',
          ...
          fields: [
            { name: 'ref', type: 'string', predicate: 'we://module/pocket/ref', required: true },
            { name: 'entity', type: 'string', predicate: 'we://module/pocket/entity', required: false },
            { name: 'datasetKey', type: 'string', predicate: 'we://module/pocket/datasetKey', required: false },
            { name: 'recordId', type: 'string', predicate: 'we://module/pocket/recordId', required: false },
            { name: 'withinEntity', type: 'string', predicate: 'we://module/pocket/withinEntity', required: false },
            { name: 'withinId', type: 'string', predicate: 'we://module/pocket/withinId', required: false },
            { name: 'label', type: 'string', predicate: 'we://module/pocket/label', required: false },
            { name: 'icon', type: 'string', predicate: 'we://module/pocket/icon', required: false },
            { name: 'thumbnail', type: 'string', predicate: 'we://module/pocket/thumbnail', required: false },
            { name: 'sourceName', type: 'string', predicate: 'we://module/pocket/sourceName', required: false },
            { name: 'sourceAuthor', type: 'string', predicate: 'we://module/pocket/sourceAuthor', required: false },
            { name: 'gatheredAt', type: 'string', predicate: 'we://module/pocket/gatheredAt', required: false },
            { name: 'note', type: 'string', predicate: 'we://module/pocket/note', required: false },
          ],
          relations: [],
        },
      ],
    },
    {
      ...
      capabilities: ['kernel:agentData', 'kernel:records', 'storage:agent', 'dock'],
      members: [],
      parts: [{ name: 'toggleButton' }],
      panels: [{ name: 'main', title: 'Notes', icon: 'note', hostOwned: true }],
      launchers: [],
      settings: [],
      activities: {},
      components: [],
      ...
      entities: [
        {
          ...
          className: 'NoteShare',
          fields: [
            { name: 'noteId', type: 'string', predicate: 'we://module/notes/noteId', required: true },
            { name: 'ref', type: 'string', predicate: 'we://module/notes/ref', required: true },
            { name: 'spaceName', type: 'string', predicate: 'we://module/notes/spaceName', required: false },
            { name: 'sharedAt', type: 'string', predicate: 'we://module/notes/sharedAt', required: false },
          ],
          relations: [],
        },
      ],
    },
    {
      ...
      capabilities: ['network:cesium-ion', 'components'],
      members: [],
      parts: [],
      panels: [],
      launchers: [],
    ...
    },
    {
      ...
      members: [],
      parts: [{ name: 'schemaMap' }, { name: 'contentTree' }, { name: 'staticDiagram' }, { name: 'knowledgeMapPosts' }],
      panels: [],
      launchers: [],
      settings: [],
      activities: {},
    ...
    },
    {
      ...
      capabilities: [],
      members: [
        { name: 'addGuardian', kind: 'action', doc: 'Begin adding a guardian.' },
        { name: 'approveRecovery', kind: 'action', doc: 'Approve an incoming recovery request.' },
        { name: 'assistantCount', kind: 'state', doc: 'How many assistants.' },
        { name: 'assistants', kind: 'state', doc: 'Roster entries for assistants.' },
        { name: 'backupConfirmed', kind: 'state', doc: 'Whether the recovery phrase backup has been confirmed.' },
        { name: 'clearSelection', kind: 'action', doc: 'Close the device detail view.' },
        { name: 'copyDid', kind: 'action', doc: 'Copy the DID to the clipboard.' },
        { name: 'deviceCount', kind: 'state', doc: 'How many devices and nodes.' },
        { name: 'devices', kind: 'state', doc: 'Roster entries for devices and nodes.' },
        { name: 'dismissEnrolment', kind: 'action', doc: 'Close the enrolment offer.' },
        {
          name: 'enrolmentOffer',
          kind: 'state',
          doc: 'The open enrolment offer: QR image, label, public key, challenge.',
        },
        { name: 'exportKel', kind: 'action', doc: 'Download the key event log as a JSON file.' },
        { name: 'guardianCount', kind: 'state', doc: 'How many guardians.' },
        { name: 'guardianRecoveryLabel', kind: 'state', doc: 'The label of the guardian recovery button.' },
        { name: 'guardians', kind: 'state', doc: 'Guardian entries with their consent status.' },
        { name: 'identity', kind: 'state', doc: 'The resolved identity: DID, display name, agent type.' },
        { name: 'incomingRecoveryRequests', kind: 'state', doc: 'Recovery requests from people this identity guards.' },
        { name: 'kelEvents', kind: 'state', doc: "The identity's key event log." },
        { name: 'pendingGuardians', kind: 'state', doc: 'Whether any guardian has yet to consent.' },
        { name: 'recoveryState', kind: 'state', doc: 'The active recovery request, or null.' },
        { name: 'revokeKey', kind: 'action', doc: 'Revoke a key and refresh the roster.' },
        { name: 'roster', kind: 'state', doc: 'Every enrolled device, node and assistant.' },
        { name: 'selectDevice', kind: 'action', doc: 'Select a device for the detail view.' },
        { name: 'selectedDevice', kind: 'state', doc: 'The full entry of the selected device, or null.' },
        { name: 'selectedDeviceId', kind: 'state', doc: 'The id of the selected device, or null.' },
        { name: 'startBackup', kind: 'action', doc: 'Begin the recovery-phrase backup ceremony.' },
        { name: 'startEnrolment', kind: 'action', doc: 'Create an enrolment offer and its QR code.' },
        { name: 'startGuardianRecovery', kind: 'action', doc: 'Open the guardian recovery ceremony.' },
        { name: 'startMnemonicRecovery', kind: 'action', doc: 'Open the recovery-phrase ceremony.' },
        { name: 'thresholdDescription', kind: 'state', doc: 'The recovery threshold in words.' },
        { name: 'thresholdLabel', kind: 'state', doc: 'The recovery threshold, like "2/3".' },
        { name: 'vetoRecovery', kind: 'action', doc: 'Veto the active recovery request.' },
      ],
      parts: [],
      panels: [],
      launchers: [],
    ...
    },
    {
      ...
      capabilities: ['kernel:records', 'storage:space'],
      members: [
        ...
        },
        {
          name: 'vote',
          kind: 'action',
          doc: 'Casts this agent’s vote on a poll, or changes it — one vote per person per poll.',
        },
      ...
      blocks: [{ entity: 'Poll', nodeType: 'poll', card: 'pollCard' }],
      entities: [
        {
          name: 'Poll',
          className: 'Poll',
          ...
          fields: [
            ...
            { name: 'closed', type: 'boolean', predicate: 'we://module/polls/closed', required: false },
            { name: 'version', type: 'number', predicate: 'we://module/polls/version', required: false },
          ],
          relations: [],
        },
        {
          ...
          className: 'Vote',
          fields: [
            { name: 'pollId', type: 'string', predicate: 'we://module/polls/pollId', required: true },
            { name: 'option', type: 'string', predicate: 'we://module/polls/option', required: true },
          ],
          relations: [],
        },
      ],
