 ...
 *
 * A module singleton rather than a context because non-component code (store factories) reads it,
 * and because there is exactly one seed per running app by definition.
 */
