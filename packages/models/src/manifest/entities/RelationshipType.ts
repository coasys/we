 ...
 */
export const RelationshipType: CoreEntityDef = {
  base: 'WeNode',
  entity: {
    ...
    properties: {
       ...
       */
      inverseName: { type: 'string', predicate: 'we://inverse_name', default: '' },
      /**
       ...
       */
      directed: { type: 'boolean', predicate: 'we://directed', default: true },
