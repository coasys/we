...
export const SignalType: CoreEntityDef = {
  base: 'WeNode',
  unions: {"mode": {"alias": "SignalMode", "values": ["toggle", "vote", "rating", "slider"]}, "aggregate": {"alias": "SignalAggregate", "values": ["count", "mean", "sum", "median"]}, "semantic": {"alias": "SignalSemantic", "values": ["approval", "quality", "relevance", "agreement", "custom"]}},
  entity: {
