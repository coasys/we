...
export type CallExtraction = M.CallExtractionModel;
export const CallExtraction = defineEntity('CallExtraction') as unknown as ModelStatic<M.CallExtractionModel>;
