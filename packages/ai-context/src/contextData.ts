  ...
  models: [
    {
      ...
      fields: [
        ...
        { name: 'profileImage', type: 'string | FileData', predicate: 'we://profile_image', required: false },
        { name: 'coverImage', type: 'string | FileData', predicate: 'we://cover_image', required: false },
      ],
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'image', type: 'string | FileData', predicate: 'we://image', required: false },
        { name: 'thumbnail', type: 'string | FileData', predicate: 'we://thumbnail', required: false },
      ],
