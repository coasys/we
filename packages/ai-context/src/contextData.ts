...
export const contextData: ContextData = {
  ...
  components: [
    ...
    },
    {
      ...
      superclass: 'DesignSystemElement',
      props: [
        { name: 'bgImage', type: 'string', optional: true },
        { name: 'bgFit', type: '"cover" | "contain"', optional: true },
        { name: 'bgPosition', type: 'string', optional: true },
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'direction', type: '"row" | "column"', optional: true },
      ],
      source: 'components',
    },
    {
    ...
    },
    {
      name: 'GroupedSelect',
      props: [
        { name: 'options', type: 'GroupedSelectOption[]', optional: false },
        { name: 'value', type: 'string', optional: true },
        { name: 'placeholder', type: 'string', optional: true },
        { name: 'searchable', type: 'boolean', optional: true },
        {
          name: 'onChange',
          type: '(((value: string) => void) & import("/home/james/Desktop/Coding/we/node_modules/.pnpm/solid-js@1.9.13/node_modules/solid-js/types/index").JSX.ChangeEventHandlerUnion<HTMLDivElement, Event>)',
          optional: true,
        },
        { name: 'styles', type: 'JSX.CSSProperties', optional: true },
        { name: 'bg', type: 'ColorValue', optional: true },
