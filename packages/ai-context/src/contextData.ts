  ...
  components: [
    ...
    },
    {
      ...
      props: [
        {
          name: 'icon',
          type: 'import("/home/josh/workspaces/coasys/we/packages/design-system/utils/dist/solid").MaybeAccessor<string>',
          optional: false,
        },
        {
          name: 'label',
        ...
        {
          name: 'selected',
          type: 'import("/home/josh/workspaces/coasys/we/packages/design-system/utils/dist/solid").MaybeAccessor<boolean | undefined>',
          optional: true,
        },
        {
          name: 'iconWeight',
          type: 'import("/home/josh/workspaces/coasys/we/packages/design-system/utils/dist/solid").MaybeAccessor<IconWeight | undefined>',
          optional: true,
        },
        {
          name: 'onClick',
          type: 'import("/home/josh/workspaces/coasys/we/packages/design-system/utils/dist/solid").MaybeAccessor<(() => void) | undefined>',
          optional: true,
        },
        {
          name: 'class',
          type: 'import("/home/josh/workspaces/coasys/we/packages/design-system/utils/dist/solid").MaybeAccessor<string | undefined>',
          optional: true,
        },
        {
          name: 'styles',
          type: 'import("/home/josh/workspaces/coasys/we/packages/design-system/utils/dist/solid").MaybeAccessor<Record<string, string | number> | undefined>',
          optional: true,
        },
      ],
      source: 'components',
  ...
  models: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'modelId', type: 'string', predicate: 'we://model_id', required: false },
        { name: 'systemPrompt', type: 'string', predicate: 'we://system_prompt', required: false },
        { name: 'personalityIds', type: 'string', predicate: 'we://personality_ids', required: false },
        { name: 'skillIds', type: 'string', predicate: 'we://skill_ids', required: false },
        { name: 'mcpServerIds', type: 'string', predicate: 'we://mcp_server_ids', required: false },
      ],
      relations: [],
    },
    {
    ...
    },
    {
      ...
      fields: [
        { name: 'name', type: 'string', predicate: 'we://name', required: false },
        { name: 'transport', type: 'string', predicate: 'we://transport', required: false, default: "'stdio'" },
        { name: 'url', type: 'string', predicate: 'we://url', required: false },
        { name: 'command', type: 'string', predicate: 'we://command', required: false },
        { name: 'auth', type: 'string', predicate: 'we://auth', required: false },
      ],
      relations: [],
    },
    {
      ...
      extends: 'WeNode',
      fields: [
        { name: 'threadId', type: 'string', predicate: 'we://thread_id', required: false },
        { name: 'role', type: 'string', predicate: 'we://role', required: false },
        { name: 'content', type: 'string', predicate: 'we://content', required: false },
        { name: 'toolCalls', type: 'string', predicate: 'we://tool_calls', required: false },
        { name: 'ts', type: 'string', predicate: 'we://ts', required: false },
        { name: 'status', type: 'string', predicate: 'we://status', required: false },
      ],
      relations: [],
    },
    {
      ...
      fields: [
        { name: 'name', type: 'string', predicate: 'we://name', required: false },
        { name: 'body', type: 'string', predicate: 'we://body', required: false },
      ],
      relations: [],
    },
    {
    ...
    },
    {
      ...
      fields: [
        { name: 'title', type: 'string', predicate: 'we://title', required: false },
        { name: 'assistantId', type: 'string', predicate: 'we://assistant_id', required: false },
        { name: 'modelId', type: 'string', predicate: 'we://model_id', required: false },
        { name: 'createdAt', type: 'string', predicate: 'we://created_at', required: false },
        { name: 'updatedAt', type: 'string', predicate: 'we://updated_at', required: false },
      ],
      relations: [{ name: 'messages', kind: 'HasMany', predicate: 'we://message', target: 'Message' }],
    },
    {
      name: 'VideoBlock',
