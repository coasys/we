...
export const contextData: ContextData = {
  primitives: [
    ...
    },
    {
      ...
      className: 'Divider',
      superclass: 'DesignSystemElement',
      ownProps: [{ name: 'orientation', type: "'horizontal' | 'vertical'", optional: false, default: "'horizontal'" }],
    },
    {
      tagName: 'we-drawer',
      className: 'Drawer',
  ...
  components: [
    {
      ...
      props: [
        ...
        { name: 'perspective', type: 'PerspectiveProxy', optional: true },
    ...
    {
      name: 'CreateSpaceModalWidget',
      props: [
        { name: 'adamClient', type: 'Ad4mClient | undefined', optional: false },
        { name: 'addNewSpace', type: '(space: Space) => void', optional: false },
        { name: 'close', type: '() => void', optional: false },
        { name: 'class', type: 'string', optional: true },
