...
export const contextData: ContextData = {
  ...
  components: [
    ...
    },
    {
      ...
      superclass: 'DesignSystemElement',
      props: [
        { name: 'visibility', type: 'Visibility', optional: true },
        { name: 'overflowX', type: 'Overflow', optional: true },
        { name: 'overflowY', type: 'Overflow', optional: true },
  ...
  models: [
    {
      ...
      fields: [
        ...
        { name: 'avatar', type: 'string | FileData', predicate: 'we://profile_image', required: false },
