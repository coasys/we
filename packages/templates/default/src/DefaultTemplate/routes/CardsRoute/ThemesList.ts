...
export const themesList: SchemaNode = cardList({
  query: {
    entity: 'Theme',
  ...
  as: 'theme',
  empty: emptyState({ icon: 'paint-brush', label: 'themes', searchable: true }),
  children: [
    cardShell({
      header: [
        {
                  ...
                  props: {
                    ...
                    then: {
                      ...
                      props: {
                        ...
                        onClick: {
                          $action: 'model.update',
                          args: ['Space', { $store: 'spaceStore.currentSpace.id' }, { defaultThemeId: '$theme.id' }],
                        },
                      },
