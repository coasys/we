        ...
        <Column gap="200">
          <Show when={rows().length > 1}>
            <Row ay="center" gap="200">
              <we-text fontSize="200" color="textMuted">
                Match
              </we-text>
              <we-select
                size="xs"
...
function ConditionRow(props: {
  ...
  return (
    <Show
      when={comparison()}
      fallback={
        <Row ay="center" gap="200" px="200" py="100" bg="surfaceSunken" r="200">
          <we-icon name="brackets-curly" size="xs" color="textFaint" />
          <we-text flex="1" fontSize="200" color="textMuted" truncate>
    ...
    >
      {(cmp) => (
        <Column gap="100" p="200" bg="surfaceSunken" r="200">
          <Row ay="center" gap="100">
