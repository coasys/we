...
export function LocationDisplay(props: LocationDisplayProps) {
  ...
  return (
    <Row class="we-location-block" gap="300" ay="center" p="300" border="1px solid neutral-200" r="300">
      ...
      <Column gap="50" flex="1">
        <Show when={mapsUrl()} fallback={<we-text variant="label">{props.name || 'Unknown Location'}</we-text>}>
          <we-link href={mapsUrl()} target="_blank" textDecoration="none" color="primary-500">
