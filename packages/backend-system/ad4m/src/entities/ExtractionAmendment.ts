/**
 * GENERATED from src/manifest/ExtractionAmendment.ts — do not edit here.
 *
 ...
 */
@Model({ name: 'ExtractionAmendment' })
export class ExtractionAmendment extends Ad4mModel {
  @Flag({ through: 'we://flag', value: 'we://extraction_amendment' })
  flag: string = '';
   ...
   */
  @Property({ through: 'we://amended_property' })
  property: string = '';
   ...
   */
  @Property({ through: 'we://previous_value' })
   ...
   */
  @HasOne({ through: 'we://amended_node', polymorphic: true })
  node?: string;
}
