/**
 * GENERATED from src/manifest/entities/ReadMarker.ts — do not edit here.
 *
 ...
 */
@Model({ name: 'ReadMarker' })
export class ReadMarker extends WeNode {
  @Flag({ through: 'we://flag', value: 'we://read_marker' })
  flag: string = '';
   ...
   */
  @Property({ through: 'we://last_read_at' })
  lastReadAt: string = '';
}
