/**
 * GENERATED from src/manifest/entities/CallExtraction.ts — do not edit here.
 *
 ...
 */
@Model({ name: 'CallExtraction' })
export class CallExtraction extends WeNode {
  @Flag({ through: 'we://flag', value: 'we://call_extraction' })
  flag: string = '';
